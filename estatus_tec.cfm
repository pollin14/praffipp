...
<title>Cambiar estatus t&eacute;cnico</title>
...
<cfif IsDefined('Form.Aceptar')>
        ...
        <cfset Status_Tecnico = #Form.estatus#>
    
        <cfset Start = 1> 
        <cfset End = 3> 
        
        <CFQUERY NAME="QRY_Prog_EntFed" DATASOURCE="prafipp">
            SELECT	(Status_Trim#trimestre#) as Status_Trim, Id_Prog, Id_EntFed, Ejercicio, Trim_CapturaT
            FROM	Prog_EntFed        
        </CFQUERY>
    
        <!---cfloop query = "QRY_Prog_EntFed" startRow = "#Start#" endRow = "#End#"--->
        <cfloop query = "QRY_Prog_EntFed">
        	<cfif (#QRY_Prog_EntFed.Trim_CapturaT# EQ #trimestre#)>
				<cfset Status_Financiero = (#QRY_Prog_EntFed.Status_Trim# \ 10) * 10>
                <cfset Status = #Status_Financiero# + #Status_Tecnico#>
        
                <cfset actualizar_estatus="	UPDATE	Prog_EntFed
                                            SET		Status_Trim#trimestre#=#Status#,Trim_CapturaT=#QRY_Prog_EntFed.Trim_CapturaT#*10
        ...
        <cfloop query = "QRY_usuarios">
            <cfif #Role# GT 2>
                <cfmail 
                    ...
                    Por este medio se les informa que ha cambiado el estatus t&eacute;cnico del trimestre <cfoutput>#trimestre#</cfoutput>o.<br /><br />
...
<h2 align="center">Cambiar estatus t&eacute;cnico</h2>
<br />

<br />

<form action="estatus_tec.cfm" name="forma" id="forma" method="post" onSubmit="return Valida(this);">
<table align="center" border="0" cellspacing="0" cellpadding="0" width="487">
  ...
  <tr>
    <td class="custom_tr">Num. del nuevo estatus t&eacute;cnico</td>
