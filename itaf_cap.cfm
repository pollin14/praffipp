...
<cfinclude template="chk_session_imp.cfm">
  ...
  <h2 class="center_text">INFORME TRIMESTRAL DE AVANCE FINANCIERO Y FISICO</h2>
...
<table id="datos_del_programa" class="center">
<CFQUERY DATASOURCE = "prafipp" NAME = "sif_dsa">
  SELECT * FROM Programas where Id_Prog=#Informe.Id_Prog#
</CFQUERY>
<CFOUTPUT QUERY = "sif_dsa">
  <tr>
    <td class="colheader first_column"><strong>PROGRAMA :</strong></td>
    <td class="colfooter">#Nom_Prog#</td>
  </tr>   
